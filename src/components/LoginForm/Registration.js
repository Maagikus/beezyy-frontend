const Registration = ({onsubmit,onBlure,isEmailValid,email,emailError,isPasswordlValid,password,passwordError,checkBoxValue,setCheckBoxValue,formValid,isPasswordSame,confirmPassword,confirmPasswordError}) => {
    return (
    <>
